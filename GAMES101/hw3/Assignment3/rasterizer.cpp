...
void rst::rasterizer::rasterize_triangle(
  ...
  // interpolated_shadingcoords; Use: Instead of passing the triangle's
  // color directly to the frame buffer, pass the color to the shaders first
  // to get the final color; Use: auto pixel_color =
